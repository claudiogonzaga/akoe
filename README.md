...
- Se for salvar o notebook de volta no GitHub depois de rodar, use antes `Editar → Limpar todas as saídas`. As saídas de execução guardam os nomes reais dos arquivos transcritos e o link da pasta usada — que, neste repositório público, ficariam visíveis para qualquer pessoa.
